...
<template>
  <div
    ...
    <div
      ...
      :class="[
        isOwnMessage
          ? 'bg-blue-500 rounded-br-3xl rounded-tr-3xl rounded-tl-xl order-2 ml-2'
          : 'bg-green-500 rounded-bl-3xl rounded-tl-3xl rounded-tr-xl mr-2',
      ]">
      <o-text
      ...
      <o-text
        ...
        size="xs">
        <o-text  size="xs" class="!text-white">
          {{ message.user.username }}, </o-text
